...
Page({
  data: {
    ...
    orderType: ['all', 'dct', 'dfh', 'dsh', 'ywc', 'dtk'],
    hasSend: false,
    promptHidden: true,
  },
  // 滚动切换标签样式
  ...
  toGroupBuy(e) {
    ...
    wx.redirectTo({
      url: '/page/component/groupBuy/groupBuy?tid=' + tid,
    })
  },
  ...
  changeType: function (e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: server + '/index.php/Home/Index/changeTuanType',
            data: {
              id: id,
              token: token,
...
function getData(self, id) {
  ...
  wx.request({
    url: server + '/index.php/Home/Index/getGroupByList',
    data: {
      id: id,
      token: token
    },
